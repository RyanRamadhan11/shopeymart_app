...
function RegisterAdmin() {
    ...
    //ini menggunakan shopeymart

    const togglePass = "../assets/images/eye.svg";
    const url = "http://localhost:8080/api/auth/register/admin"; // Updated URL
                    ...
                    <div className="card-body p-md-5">
                        ...
                        <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                            ...
                            <div className="mt-4 mx-4 mb-3 mb-lg-4" style={{paddingLeft: '1em'}}>
                                <button type="button" className="btn btn-warning btn-block mb-3 fw-bold" onClick={handleAddAdmin}>
                                Register
                                </button>
                            </div>
